            ...
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-16 border-b border-white/5">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 text-base leading-relaxed font-light max-w-xs">
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                <Link
                                    key={l.label}
                                    href={l.href}
                                    className="block text-base text-gray-500 hover:text-white transition-colors duration-400 font-light"
                                >
                                    {l.label}
                                </Link>
                            ))}
                ...
                <div className="pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-[14px] text-gray-700 uppercase tracking-[0.3em] font-bold">
                    ...
                    <div className="flex flex-col items-center gap-1.5 opacity-40 hover:opacity-80 transition-opacity duration-700">
                        <p className="text-[14px] text-gray-600 uppercase tracking-[0.2em]">
                            Engineered by <span className="text-white font-bold">floridev07</span>
                        </p>
                        <p className="text-[13px] text-gray-700 tracking-widest">
